                ...
                <div class="col-lg-7 col-12">
                    <div class="hero-text">
                        <div class="hero-title-wrap d-flex align-items-center mb-4">
                            <h1 class="hero-title  mb-0">Muhammad Fajar Adammullah</h1>
                        </div>
                        <h2 class="mb-4 text-center text-blue-500">Siswa SMK Baktu Nusantara Pengembangan Perangkat Lunak & Gim</h2>
                    </div>
                </div>
